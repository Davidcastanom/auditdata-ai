...
| C5 | **Códigos de categoría inconsistentes** entre docstring (28: 12+16, nombres `EMPTY`, `NUMERIC_OUTLIER`...), código real (`MISSING`, `TYPE_PER_CELL`, `BOOL_INCONSISTENCY`...) y mapa de severidad del frontend (`MISSING`, `OUT_OF_RANGE`...). | README.md:88-100, diagnostic.py, nube.js:351 | Documentación, motor y UI hablan 3 idiomas distintos. |
