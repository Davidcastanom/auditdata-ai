...
| FE-05 | XLSX `data_only=True` → celdas calculadas vacías | Algo. F5 | F1 | HECHO | 2026-08-03 |
...
| DG-03 | Rama muerta `_check_categorical_suspicious` (elif inalcanzable) | Motor B4 | F5 | HECHO | 2026-08-03 |
