...
[![Tests](https://img.shields.io/badge/Tests-233%2F233%20passed-brightgreen?style=flat-square)](tests/)
[![Playwright](https://img.shields.io/badge/E2E-41%20passed-brightgreen?style=flat-square)](tests/frontend)
...
- **Consentimiento de tratamiento de datos** registrado antes de guardar historial (`user_consents`).
...
```bash
# Suite completa de Python (233 tests)
...
- [x] CI: pytest en cada push/PR + 233 tests Python + 41 E2E Playwright
